...
private const val keywordPattern = "\\b(const|val|var|fun|by|in|if|else|for|while|when|object|return|true|false|null|class|enum|override|data|import|super|suspend|private)\\b"

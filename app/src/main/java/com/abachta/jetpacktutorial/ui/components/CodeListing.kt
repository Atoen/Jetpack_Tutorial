...
private const val keywordPattern = "\\b(val|var|fun|by|in|if|else|for|while|when|object|return|true|false|null|class|override|data|import|super|suspend|private)\\b"
